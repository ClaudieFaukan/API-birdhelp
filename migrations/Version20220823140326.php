 ...
 */
final class Version20220823140326 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE geographic_coordinate ADD diff_dist DOUBLE PRECISION');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE geographic_coordinate DROP diff_dist');
    }
}
